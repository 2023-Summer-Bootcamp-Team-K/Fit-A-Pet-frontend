...
class _ChartScreenState extends State<ChartScreen> {
  ...
  void onDateSelected(DateTime newDate) {
    setState(() {
      selectedDate = newDate;
      _chartWidgets[0] = DailyChart(
          petID, selectedDate.month, selectedDate.day, onDateSelected);
    });
  }
            ...
            onPressed: () {
              setState(() {
                ...
                if (selectedDate != null) {
                  _chartWidgets[0] = DailyChart(petID, selectedDate.month,
                      selectedDate.day, onDateSelected);
                }
          ...
          content: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                  '반려동물에게 인슐린 주사를 투여한 후, 최저점이 100mg/dL 이하일 경우 병원 내원 및 당 섭취를 권고드립니다.',
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 17,
                  ),
