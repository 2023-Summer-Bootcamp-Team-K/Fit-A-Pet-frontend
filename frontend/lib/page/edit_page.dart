...
class _EditPageState extends State<EditPage> {
  ...
  void initState() {
    super.initState();
    _selectedSpecies = speciesOptions[0];
    _selectedGender = genderOptions[0];
    _selectedFeed = feedOptions[0];
    _selectedSoreSpot = soreSpotOptions[0];
  }
  ...
  void _registerPet() async {
    final String apiUrl =
        'http://54.180.70.169/api/pets/modify/123/'; //modify/120/(petid=> 2번pet) //create/2/(userid=> 2번user) //list/3/(조회=userid) //delete/4/(삭제=petid)
  ...
  void _deletePet() async {
    final String apiUrl = //404 실패 , 204 성공
        'http://54.180.70.169/api/pets/delete/121/'; //modify/120/(petid=> 2번pet) //create/2/(userid=> 2번user) //list/3/(조회=userid) //delete/4/(삭제=petid)
