...
class _NotificationPageState extends State<NotificationPage> {
                  ...
                  Row(
                    children: [
                      buildButton(
                          0,
                          '09:00',
                          AndroidNotificationDetails('alarm 1', '1번 푸시'),
                          DarwinNotificationDetails()),
                      buildButton(
                          1,
                          '11:00',
                          AndroidNotificationDetails('alarm 2', '2번 푸시'),
                          DarwinNotificationDetails()),
                      buildButton(
                          2,
                          '13:00',
                          AndroidNotificationDetails('alarm 3', '3번 푸시'),
                          DarwinNotificationDetails()),
                    ],
                  ),
                  Row(
                    children: [
                      buildButton(
                          3,
                          '15:00',
                          AndroidNotificationDetails('alarm 4', '4번 푸시'),
                          DarwinNotificationDetails()),
                      buildButton(
                          4,
                          '18:00',
                          AndroidNotificationDetails('alarm 5', '5번 푸시'),
                          DarwinNotificationDetails()),
                      buildButton(
                          5,
                          '20:00',
                          AndroidNotificationDetails('alarm 6', '6번 푸시'),
                          DarwinNotificationDetails()),
                    ],
                  )
                ],
  ...
  void _scheduleNotification(AndroidNotificationDetails androidDetails,
      DarwinNotificationDetails iosDetails) async {
    if (_selectedTime != null) {
